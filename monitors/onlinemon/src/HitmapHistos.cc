...
//    _totCluster->Draw("goff");
    ...
    _efficencyPerEvent->SetCanExtend(1);
    ...
    _pixelChargeProfile->SetCanExtend(1);
    ...
    _clusterChargeProfile->SetCanExtend(1);
    ...
    _histoMap["clusterChargeTimeProfile"]->SetCanExtend(1);
