...
namespace eudaq {
  ...
  class DLLEXPORT RunControl {
    public:
      ...
      void Configure(const std::string & settings, const std::string & aux_param, const std::map<std::string, int>& extras); ///< Send 'Configure' command with settings
