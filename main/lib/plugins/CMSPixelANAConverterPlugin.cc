...
namespace eudaq {
  ...
  static const char* EVENT_TYPE = "CMSPixelANA";

  class CMSPixelANAConverterPlugin : public DataConverterPlugin {
  public:
  ...
  private:
    CMSPixelANAConverterPlugin() : DataConverterPlugin(EVENT_TYPE),
				   m_converter(EVENT_TYPE) {}

    CMSPixelHelper m_converter;
    static CMSPixelANAConverterPlugin m_instance;
  };
  CMSPixelANAConverterPlugin CMSPixelANAConverterPlugin::m_instance;
}
